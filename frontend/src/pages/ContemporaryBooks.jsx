// pages/ContemporaryBooks.jsx
import { useEffect, useState } from "react";

export default function ContemporaryBooks() {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/contemporarybooks?limit=${limit}&page=${page}`)
      .then(res => res.json())
      .then(data => {
        setBooks(data.books || []);
