// pages/EnglishBooks.jsx
import { useEffect, useState } from "react";

export default function EnglishBooks() {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/englishbooks?limit=${limit}&page=${page}`)
      .then(res => res.json())
      .then(data => {
        setBooks(data.books || []);
