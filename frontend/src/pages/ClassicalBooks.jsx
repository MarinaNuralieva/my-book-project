// pages/ClassicalBooks.jsx
import { useEffect, useState } from "react";

export default function ClassicalBooks() {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/api/classicalbooks?limit=${limit}&page=${page}`)
      .then(res => res.json())
      .then(data => {
        setBooks(data.classicalbooks || []);
